...
class SingleFarmOahu(Coupled):
    ...
    def __init__(self, simulation_filename: str):
        """Función de inicialización."""
        super().__init__("DataCenter")

        # Simulation file
        simulation_filepath = os.path.join('data', 'input', 'simulations', simulation_filename)
        ...
        farm_name = "Oahu"
        # Basic sensors info:
        h5 = tb.open_file(os.path.join('data', 'input', farm_name, 'sensors_data.h5'), 'r')
        ...
        # Main fog server
        oahu = FarmServer(farm_name, sensor_names, sensor_latitudes, sensor_longitudes, sensor_means, sensor_stdevs)
