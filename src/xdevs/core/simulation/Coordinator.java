...
public class Coordinator extends AbstractSimulator {
	...
	/**
	 * @see xdevs.core.simulation.Coordinator#simInject(double,
	 *      xdevs.core.modeling.Port, java.util.Collection)
	 * @param port   input port to inject the set of values
	 * @param values set of values to inject
	 */
	...
	/**
	 * Injects a single value in the given input port with elapsed time e equal to
	 * 0.
	 *
	 * @see xdevs.core.simulation.Coordinator#simInject(double,
	 *      xdevs.core.modeling.Port, java.util.Collection)
